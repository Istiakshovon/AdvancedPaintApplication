package com.istiak.advancedpaintapplication;
    ...
    public void saveImage () {
        ...
        if (subDirectory.exists()) {
            ...
            try {
                ...
                Toast.makeText(getContext(), "saved(internet_storage/Pictures/Paint/drawing_"+(count + 1) +".png"+")", Toast.LENGTH_LONG).show();
